...
{
    opts.DefaultTheme   = new Md3Theme();        // active design system
...
**Icons** use Material Symbol names: `Icon="search"`, `Icon="delete"`, or the `<FlareIcon Name="..." />` component.
...
(`<FlareDialogProvider/>`, `<FlareSnackbarProvider/>`, `<FlareMessageBoxProvider/>`) must exist once in the layout.
...
selection, column reorder/resize/visibility, virtualization, and column bands.
...
_Source: https://jrfrigat.github.io/Flare/docs/en/ai-agents.html_
